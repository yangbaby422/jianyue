      ...
      !(function(){
        var uniAppViewReadyCallback = function(){
          setCssToHead([".",[1],"list-item-heigher { height: 80px; display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; }\n.",[1],"left { -webkit-box-flex: 1; -webkit-flex: 1 1 30%; -ms-flex: 1 1 30%; flex: 1 1 30%; margin-top: 30px; }\n.",[1],"right { -webkit-box-flex: 1; -webkit-flex: 1 1 70%; -ms-flex: 1 1 70%; flex: 1 1 70%; margin-top: 20px; }\n",],undefined,{path:"./pages/info/info.wxss"})();
